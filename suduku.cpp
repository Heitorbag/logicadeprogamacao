...
int main()
{
    ...
    int tabuleiro4[9][9]={{0,3,4,6,7,8,9,1,2},{0,7,2,1,9,5,3,4,8},{0,9,8,3,4,2,5,6,7},{0,5,9,7,6,1,4,2,3},{0,2,6,8,5,3,7,9,1},{0,1,3,9,2,4,8,5,6},{0,6,1,5,3,7,2,8,4},{0,8,7,4,1,9,6,3,5},{0,4,5,2,8,6,1,7,9}};
    //5/6/1/8/4/7/9/2/3
    //tabuleiro4 teste completo
    
    int matriz[tamanho][tamanho];
    
    // aleatorizar qual tabuleiro (peguei a bliblioteca na net)
    srand(time(0));
    ...
    do
    {
        ...
        for(int i=0;i<9;i++)
        {
            ...
            for(int j=0;j<9;j++)
            {
                if(b==3) // colocar | para dividir os blocos no tabuleiro
                {
                    if(a==36) 
                    {
                        a=0,b=0;
            ...
            cout<<"]";
            cout<<"\n";
            if(c==108) // colocar -- para separar os blocos no tabuleiro
            {
                cout<<" [-----------------------------]"<<"\n"; 
                c=0;
            }
        ...
        {
            coluna--,linha--;
            if(matriz[coluna][linha]==0) // verifica a escolha do jogador e adiciona o numero na matriz
            { 
        ...
        if (aindaEstaValido==false) 
        {
            ...
            for(int i=0;i<9;i++)
            {
                for(int j=0;j<9;j++) // verifica se o Tabuleiro esta completo
                {
                    if(matriz[i][j]!=0) 
                    {
                     fx+=1;
